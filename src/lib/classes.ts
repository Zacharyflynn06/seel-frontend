...
export const animatedTouchClasses =
	'duration-400 transform-gpu transition-all ease-in-out hover:scale-101 active:scale-99';
...
export const inputBaseColors = 'bg-off-white dark:bg-off-black';
...
export const cardHeadingClasses = 'font-spartan text-2xl font-bold text-black dark:text-white';
