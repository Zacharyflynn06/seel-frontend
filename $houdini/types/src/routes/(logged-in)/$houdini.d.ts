...
type LayoutRouteId = RouteId | "/(logged-in)/(dashboardWrapper)/dashboard" | "/(logged-in)/admin" | "/(logged-in)/admin/manage-fields" | "/(logged-in)/admin/manage-investing-entities" | "/(logged-in)/chat-demo" | "/(logged-in)/olddashboard" | "/(logged-in)/olddashboard/[investingEntityId]" | "/(logged-in)/olddashboard/[investingEntityId]/[companyId]" | "/(logged-in)/olddashboard/[investingEntityId]/[companyId]/[documentCollectionId]" | "/(logged-in)/submit-deals"
