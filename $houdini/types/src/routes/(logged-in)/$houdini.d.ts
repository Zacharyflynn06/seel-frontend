...
type LayoutRouteId = RouteId | "/(logged-in)/admin" | "/(logged-in)/admin/manage-fields" | "/(logged-in)/admin/manage-investing-entities" | "/(logged-in)/chat-demo" | "/(logged-in)/dashboard" | "/(logged-in)/investments/[companyId]" | "/(logged-in)/oldDashboard" | "/(logged-in)/oldDashboard/[investingEntityId]" | "/(logged-in)/oldDashboard/[investingEntityId]/[companyId]" | "/(logged-in)/oldDashboard/[investingEntityId]/[companyId]/[documentCollectionId]" | "/(logged-in)/oldSubmit-deals" | "/(logged-in)/submit-deals"
