...
type LayoutRouteId = RouteId | "/(logged-in)/admin" | "/(logged-in)/chat-demo" | "/(logged-in)/dashboard" | "/(logged-in)/dashboard/[investingEntityId]" | "/(logged-in)/dashboard/[investingEntityId]/[companyId]" | "/(logged-in)/dashboard/[investingEntityId]/[companyId]/[documentCollectionId]" | "/(logged-in)/submit-deals"
