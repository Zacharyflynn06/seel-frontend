...
type LayoutRouteId = RouteId | "/(auth)/forgot-password" | "/(auth)/log-in" | "/(auth)/log-out" | "/(auth)/new-password" | "/(auth)/sign-up" | "/(logged-in)/admin" | "/(logged-in)/admin/manage-fields" | "/(logged-in)/admin/manage-investing-entities" | "/(logged-in)/chat-demo" | "/(logged-in)/dashboard" | "/(logged-in)/oldDashboard" | "/(logged-in)/oldDashboard/[investingEntityId]" | "/(logged-in)/oldDashboard/[investingEntityId]/[companyId]" | "/(logged-in)/oldDashboard/[investingEntityId]/[companyId]/[documentCollectionId]" | "/(logged-in)/submit-deals" | "/(public)" | "/(public)/about" | "/(public)/privacy-policy" | null
