...
type LayoutRouteId = RouteId | "/(auth)/forgot-password" | "/(auth)/log-in" | "/(auth)/log-out" | "/(auth)/new-password" | "/(auth)/sign-up" | "/(logged-in)/admin" | "/(logged-in)/admin/manage-fields" | "/(logged-in)/admin/manage-investing-entities" | "/(logged-in)/chat-demo" | "/(logged-in)/dashboard" | "/(logged-in)/dashboard/[investingEntityId]" | "/(logged-in)/dashboard/[investingEntityId]/[companyId]" | "/(logged-in)/dashboard/[investingEntityId]/[companyId]/[documentCollectionId]" | "/(logged-in)/newDashboard" | "/(logged-in)/submit-deals" | "/(public)" | "/(public)/about" | "/(public)/privacy-policy" | null
