...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[AddDocumentToCollectionUrlStore, AddDocumentToCollectionUrl$result, AddDocumentToCollectionUrl$input], [AskCollectionStore, AskCollection$result, AskCollection$input], [GetInvestingEntitiesStore, GetInvestingEntities$result, GetInvestingEntities$input], [AskSeelStore, AskSeel$result, AskSeel$input], [GetUserStore, GetUser$result, GetUser$input], [GetUsersStore, GetUsers$result, GetUsers$input]];
};